...
\urlstyle{same}
\hypersetup{
  pdftitle={iDE Global MERL Handbook},
  pdfauthor={Tasbiul Islam Nibir},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{iDE Global MERL Handbook}
...
\hypertarget{purpose-of-the-handbook}{%
\section*{Purpose of the Handbook}\label{purpose-of-the-handbook}}
\addcontentsline{toc}{section}{Purpose of the Handbook}
...
\chapter*{About iDE?}\label{about-ide}}
\addcontentsline{toc}{chapter}{About iDE?}
...
\hypertarget{merl-workflow}{%
\chapter*{MERL Workflow}\label{merl-workflow}}
\addcontentsline{toc}{chapter}{MERL Workflow}
...
\textbf{Note:} Here the {[}p{]} stands for project based and {[}i{]} stands for Institutional.
Read (\#about) for further information.

\includegraphics{MERL_Work_Flow_files/figure-latex/unnamed-chunk-1-1.pdf}
...
{\centering \includegraphics[width=0.8\linewidth]{MERL_Work_Flow_files/figure-latex/nice-fig-1} 
